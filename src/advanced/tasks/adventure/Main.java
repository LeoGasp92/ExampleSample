...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        //Put all Location in Location map
        ...
        vocabulary.put("NORD","N");
        vocabulary.put("SUD","S");
        vocabulary.put("EST","E");
        vocabulary.put("OVEST","W");

        //Set initial starting location
        int location = 1;
        while(true){
            //Printing description of current location
            System.out.println(locationMap.get(location).getDescription());
            //Quit game if location is 0
            if(location == 0){
                break;
            }
            //Printing possible exits for current location
            ...
            if(exits.containsKey(direction)){
                ...
                System.out.print("Walking to next location");
...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        // Vocabularyfor starting possible accepted words
        Map<String, String> vocabulary = new HashMap<String, String>();
        vocabulary.put("QUIT","Q");
        vocabulary.put("NORTH","N");
        vocabulary.put("SOUTH","S");
        ...
        while(true){
            ...
            // Printing possible exists for current location
            Map<String, Integer> exits = locationMap.get(location).getExits();
            ...
            if(exits.containsKey(direction)){
                ...
                System.out.println("Ops! Can't go that direction ! \n");
            }
        }
    }
}
